...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <url>http://fengxici.github.io</url>
    ...
    <!--项目的问题管理系统(Jira,或任何你喜欢的问题管理系统)的名称和URL，本例为 jira -->
    <issueManagement>
        <!--问题管理系统（例如jira）的名字， -->
        <system>jira</system>
        <!--该项目使用的问题管理系统的URL -->
        <url>http://jira.timingtech.top</url>
    </issueManagement>
    <!--项目持续集成信息 -->
    <ciManagement>
        <!--持续集成系统的名字，例如jenkins -->
    ...
    <developers>
        ...
        <developer>
            ...
            <!--项目开发者所属组织的URL -->
            <organizationUrl>http://fengxici.github.io</organizationUrl>
            <!--项目开发者属性，如即时消息如何处理等 -->
            <properties>
                <dept>No</dept>
            </properties>
    ...
    <licenses>
        ...
        <license>
            ...
            <name>Apache 2</name>
            <!--官方的license正文页面的URL -->
            <url>http://fengxici.github.io/LICENSE-2.0.txt</url>
